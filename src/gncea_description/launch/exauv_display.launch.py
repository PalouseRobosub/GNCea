#!/usr/bin/env python3
# Launch exauv in Gazebo Harmonic (ROS 2 Jazzy) in a portable way.
...
def generate_launch_description():
    ...
    # Your actual path:
    default_model = os.path.join(pkg_share, "urdf", "exampleAUV", "exauv.urdf")
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("name",  default_value="exauv",        description="Entity name in Gazebo"),
